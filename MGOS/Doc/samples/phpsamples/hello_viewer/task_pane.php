...
43.743934, 5000, true);</code></pre>
    ...
    <p><strong>2.</strong> Click <a href="gotopoint.php?X=-87.724520&Y=43.768387&Scale=5000" target="scriptFrame">this link</a>
    to display a different location. This loads a page into the hidden script frame.</p>
    <?php
    $dir = getcwd();
    $fullPath = urlencode($dir);
    ?>
    <p>View source for support file:</p>
    <ul>
      <li><a target="_blank" href="../common/viewsource.php?FILENAME=<?= $fullPath ?>/gotopoint.php">gotopoint.php</a></li>
    </ul>
    ...
    <ul>
      <li><a target="_blank" href="../common/viewsource.php?FILENAME=<?= $fullPath ?>/task_pane.php">task_pane.php</a></li>
    </ul>
    ...
    <ul>
      <li>
        <a target="_blank" href="../common/viewsource.php?FILENAME=<?= $fullPath ?>/../index.php" >index.php</a>
      </li>
      <li>
