...
#ifndef _FS_KML_GET_LAYER_H
#define _FS_KML_GET_LAYER_H

class MgHttpKmlGetLayer : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpKmlGetLayer(MgHttpRequest *hRequest);
