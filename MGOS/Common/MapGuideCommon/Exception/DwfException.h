...
#ifndef MG_DWF_EXCEPTION_H_
#define MG_DWF_EXCEPTION_H_
...
///
class MG_MAPGUIDE_API MgDwfException : public MgThirdPartyException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = MapGuide_Exception_MgDwfException;
};
