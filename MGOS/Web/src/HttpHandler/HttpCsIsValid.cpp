...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpCsIsValid)
...
/// nothing
/// </returns>
MgHttpCsIsValid::MgHttpCsIsValid(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpCsIsValid::Execute(MgHttpResponse& hResponse)
{
    ...
    MG_HTTP_HANDLER_CATCH_AND_THROW_EX(L"MgHttpCsIsValid.Execute")
}
