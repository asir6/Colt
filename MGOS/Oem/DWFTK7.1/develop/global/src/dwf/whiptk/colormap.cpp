...
///////////////////////////////////////////////////////////////////////////
WT_Color_Map::WT_Color_Map(int file_revision_being_used)
    : m_size(256)
    , m_incarnation(-1)
...
///////////////////////////////////////////////////////////////////////////
WT_Color_Map::WT_Color_Map(int count, WT_RGBA32 const * map, WT_File & file)
    : m_size(count)
...
///////////////////////////////////////////////////////////////////////////
WT_Color_Map::WT_Color_Map(int count, WT_RGB const * map, WT_File & file)
    : m_size(count)
    , m_incarnation(file.next_incarnation())
    , m_stage(Getting_Count)
    , m_map(WD_Null)
...
///////////////////////////////////////////////////////////////////////////
WT_Color_Map::WT_Color_Map(WT_Color_Map const & cmap)
    : WT_Attribute()
  , m_size(cmap.size())
...
///////////////////////////////////////////////////////////////////////////
void WT_Color_Map::set(int count, WT_RGB const * map, WT_File & file)
{
    WD_Assert(count >= 0);
    WD_Assert(count <= 256);
...
///////////////////////////////////////////////////////////////////////////
void WT_Color_Map::set(int count, WT_RGBA32 const * map, WT_File & file)
{
    WD_Assert(count >= 0);
    WD_Assert(count <= 256);
...
///////////////////////////////////////////////////////////////////////////
WT_Color_Map const & WT_Color_Map::operator=(WT_Color_Map const & cmap)
{
    delete []m_map;
