...
public:
    ...
    WT_Integer16 pattern_number() const {return m_hashpatnum;}

	/// Width of the pattern in points  
    WT_Unsigned_Integer16 xsize() const {return m_xsize;}
	
	/// Height of the pattern in points
    WT_Unsigned_Integer16 ysize() const {return m_ysize;}
