...
//
//  <summary>
//  Constructs a MgSiteServiceHandler object with the given parameters.
//  </summary>
//
//  <param name = "data">
...
//  data stream.
//  </param>
MgSiteServiceHandler::MgSiteServiceHandler(MgStreamData* data,
...
///////////////////////////////////////////////////////////////////////////
//  <summary>
//  The destructor for the MgSiteServiceHandler object.
//  </summary>
MgSiteServiceHandler::~MgSiteServiceHandler( void )
{
}
...
IMgServiceHandler::MgProcessStatus MgSiteServiceHandler::ProcessOperation()
{
    ...
    handler.reset(MgSiteOperationFactory::GetOperation(
    ...
    MG_CATCH(L"MgSiteServiceHandler.ProcessOperation")
