...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpCsConvertEpsgCodeToWkt)
...
/// nothing
/// </returns>
MgHttpCsConvertEpsgCodeToWkt::MgHttpCsConvertEpsgCodeToWkt(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpCsConvertEpsgCodeToWkt::Execute(MgHttpResponse& hResponse)
{
    ...
    MG_HTTP_HANDLER_CATCH_AND_THROW_EX(L"MgHttpCsConvertEpsgCodeToWkt.Execute")
}
