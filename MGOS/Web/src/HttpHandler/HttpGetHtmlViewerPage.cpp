...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpGetHtmlViewerPage)
...
/// nothing
/// </returns>
MgHttpGetHtmlViewerPage::MgHttpGetHtmlViewerPage(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpGetHtmlViewerPage::Execute(MgHttpResponse& hResponse)
{
