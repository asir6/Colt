...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpEnumerateDataStores)
...
/// nothing
/// </returns>
MgHttpEnumerateDataStores::MgHttpEnumerateDataStores(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpEnumerateDataStores::Execute(MgHttpResponse& hResponse)
{
