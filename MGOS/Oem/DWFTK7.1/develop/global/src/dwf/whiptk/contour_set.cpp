...
{
    set(file.next_incarnation(), contours, counts, total_point_count, points, copy);
}
...
///////////////////////////////////////////////////////////////////////////
void WT_Contour_Set::transform(WT_Transform const & transform)
{
    if (!m_transformed)
    {
...
///////////////////////////////////////////////////////////////////////////
#if DESIRED_CODE(WHIP_OUTPUT)
void WT_Contour_Set::relativize(WT_File & file)
{
    if (!m_relativized)
    {
...
#else
void WT_Contour_Set::relativize(WT_File &)
{
}
#endif  // DESIRED_CODE()

///////////////////////////////////////////////////////////////////////////
void WT_Contour_Set::de_relativize(WT_File & file)
{
    if (m_relativized)
    {
...
{
    if (m_incarnation == other.m_incarnation)
        return WD_True;
...
///////////////////////////////////////////////////////////////////////////
WT_Contour_Set const & WT_Contour_Set::operator=(WT_Contour_Set const & source)
{
    set (   source.m_incarnation,
            source.m_num_contours,
            source.counts(),
