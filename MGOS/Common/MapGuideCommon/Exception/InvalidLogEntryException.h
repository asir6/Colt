...
///
class MG_MAPGUIDE_API MgInvalidLogEntryException : public MgApplicationException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = MapGuide_Exception_MgInvalidLogEntryException;
};
