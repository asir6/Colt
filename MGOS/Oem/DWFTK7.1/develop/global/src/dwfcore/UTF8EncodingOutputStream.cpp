...
throw( DWFException )
{
    ...
    {
        _DWFCORE_THROW( DWFNullPointerException, L"No stream to flush" );
    }
...
throw( DWFException )
{
    if (_pOutputStream == NULL)
    {
        _DWFCORE_THROW( DWFNullPointerException, L"No stream to write to" );
    }
    ...
    DWFCORE_ZERO_MEMORY( _pBuffer, _nBufferBytes );
