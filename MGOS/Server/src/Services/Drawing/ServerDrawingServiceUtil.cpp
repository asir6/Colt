...
MgServerDrawingServiceUtil::MgServerDrawingServiceUtil()
{
}
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_layer(WT_Layer &layer, WT_File &file)
{
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_color(WT_Color &color, WT_File &file)
{
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_contour_set(WT_Contour_Set &contour_set, WT_File &file)
{
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_filled_ellipse(WT_Filled_Ellipse &filled_ellipse, WT_File &file)
{
    if ( DetectTargetLayer(file) )
    {
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_gouraud_polyline(WT_Gouraud_Polyline &gouraud_polyline, WT_File &file)
{
    if ( DetectTargetLayer(file) )
    {
        // write the outline_ellipse to the output W2D/DWF
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_gouraud_polytriangle(WT_Gouraud_Polytriangle &gouraud_polytriangle, WT_File &file)
{
    if ( DetectTargetLayer(file) )
    {
        // write the outline_ellipse to the output W2D/DWF
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_image(WT_Image &image, WT_File &file)
{
    if ( DetectTargetLayer(file) )
    {
        // write the outline_ellipse to the output W2D/DWF
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_png_group4_image(WT_PNG_Group4_Image &image, WT_File &file)
{
    if ( DetectTargetLayer(file) )
    {
        // write the outline_ellipse to the output W2D/DWF
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_outline_ellipse(WT_Outline_Ellipse &outline_ellipse, WT_File &file)
{
    if ( DetectTargetLayer(file) )
    {
        // write the outline_ellipse to the output W2D/DWF
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_polyline(WT_Polyline &polyline, WT_File &file)
{
    if ( DetectTargetLayer(file) )
    {
        // write the polyline to the output W2D/DWF.
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_polygon(WT_Polygon &polygon, WT_File &file)
{
    if ( DetectTargetLayer(file) )
    {
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_polymarker(WT_Polymarker &polymarker, WT_File &file)
{
    if ( DetectTargetLayer(file) )
    {
        TargetLayer* targetLayer = (TargetLayer*)file.heuristics().user_data();
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_polytriangle(WT_Polytriangle &polytriangle, WT_File &file)
{
    if ( DetectTargetLayer(file) )
    {
...
WT_Result MgServerDrawingServiceUtil::MgWt_process_text(WT_Text &text, WT_File &file)
{
    if ( DetectTargetLayer(file) )
    {
...
bool MgServerDrawingServiceUtil::DetectTargetLayer(WT_File &file)
{
...
DWFPackageReader* MgServerDrawingServiceUtil::OpenDrawingResource(
...
void MgServerDrawingServiceUtil::CloseDrawingResource(bool& bOpenTempFile, CREFSTRING tempFileName)
{
    if (bOpenTempFile)
    {
...
void MgServerDrawingServiceUtil::ParseDrawingResourceContent(
