...
#ifndef MGWEBSUPPORT_H
#define MGWEBSUPPORT_H

class MgHttpResponse;

/////////////////////////////////////////////////////////////////
/// <summary>
/// Initializes web tier components.  The web tier
/// must be initialized with the appropriate config file before it is used.
/// </summary>
/// <param name="configFile">
/// Full path and name of web tier configuration file
/// </param>
