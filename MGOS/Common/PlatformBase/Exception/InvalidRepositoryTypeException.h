...
///
class MG_PLATFORMBASE_API MgInvalidRepositoryTypeException : public MgApplicationException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = PlatformBase_Exception_MgInvalidRepositoryTypeException;
};
