...
#ifndef _MGHTTPCREATESESSION_H_
#define _MGHTTPCREATESESSION_H_

class MgHttpCreateSession : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpCreateSession(MgHttpRequest *hRequest);
