...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpInheritPermissionsFrom)
...
MgHttpInheritPermissionsFrom::MgHttpInheritPermissionsFrom(MgHttpRequest* hRequest)
{
...
void MgHttpInheritPermissionsFrom::Execute(MgHttpResponse& hResponse)
{
    ...
    // Run API command
    mgprService->InheritPermissionsFrom(&mgrIdentifier);

    MG_HTTP_HANDLER_CATCH_AND_THROW_EX(L"MgHttpInheritPermissionsFrom.Execute")
}
