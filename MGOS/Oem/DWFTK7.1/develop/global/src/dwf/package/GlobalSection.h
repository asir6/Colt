...
public:
    ...
    ///
    typedef vector<DWFGlobalSection*>                                           tList;
    ///
    ...
    ///
    typedef multimap<const wchar_t*, DWFGlobalSection*, tDWFWCharCompareLess>   tMultiMap;
...
public:
    ...
    public:
        ...
        ///
        ///\copydoc DWFGlobalSection::Factory::build(const DWFString&,const DWFString&,DWFPackageReader*)
        ///
        _DWFTK_API
        virtual DWFSection* build( const DWFString&     zName,
                                   const DWFString&     zTitle,
...
public:
    ...
    ///
    _DWFTK_API
    DWFEPlotGlobalSection( const DWFString& zTitle = L"",
...
public:
    ...
    ///
    _DWFTK_API
    DWFEModelGlobalSection( const DWFString& zTitle = L"",
                            const DWFSource& rSource = DWFSource(L"",L"",L"") )
        throw()
