...
#include "HttpGetRepositoryContent.h"

HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpGetRepositoryContent)
...
/// nothing
/// </returns>
MgHttpGetRepositoryContent::MgHttpGetRepositoryContent(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpGetRepositoryContent::Execute(MgHttpResponse& hResponse)
{
