...
///////////////////////////////////////////////////////////////////////////
WT_Boolean WT_Delineate::delineate()const
{
    return m_delineate;
}

///////////////////////////////////////////////////////////////////////////
WT_Delineate const & WT_Delineate::operator=(WT_Boolean const & delineate_state)
{
    m_delineate = delineate_state;
    return *this;
}
...
WT_Result WT_Delineate::sync (WT_File & file) const
{
    ...
    // write out the new value of delineate only if its true. 
    // to turn off delineate , fillmode should be turned on.
    if (*this != file.rendition().delineate() && this->m_delineate)
    {
