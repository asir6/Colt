...
<P>
There are now two versions of the SymbolDefinition schema.
</P>
<P>
All symbol definitions from MapGuide Open Source prior to MapGuide Open Source 2.0 use schema version 1.0.0.  Symbol definitions created or updated in
