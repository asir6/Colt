...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpCsConvertWktToCoordinateSystemCode)
...
/// </returns>
void MgHttpCsConvertWktToCoordinateSystemCode::Execute(MgHttpResponse& hResponse)
{
    ...
    MG_HTTP_HANDLER_CATCH_AND_THROW_EX(L"MgHttpCsConvertWktToCoordinateSystemCode.Execute")
}
