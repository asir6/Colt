...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpGetClasses)
...
/// nothing
/// </returns>
MgHttpGetClasses::MgHttpGetClasses(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpGetClasses::Execute(MgHttpResponse& hResponse)
{
