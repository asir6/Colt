...
#define DEFINEGETSETMETHODS(VARIABLETYPE, METHODNAME)\
    /** \brief Returns the value of the local VARIABLETYPE variable METHODNAME. */ VARIABLETYPE get_##METHODNAME() const {\
   return m_##METHODNAME;\
}\
/** \brief Sets the value of the local VARIABLETYPE variable METHODNAME. */ void set_##METHODNAME(VARIABLETYPE local_variable_name) {\
...
public:
    ...
    /// Sets the blockref format, one of \ref WT_BlockRef_Format "enum WT_BlockRef_Format."
