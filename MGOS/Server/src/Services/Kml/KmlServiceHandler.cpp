...
//
//  <summary>
//  Constructs a MgKmlServiceHandler object with the given parameters.
//  </summary>
//
//  <param name = "data">
...
//  data stream.
//  </param>
MgKmlServiceHandler::MgKmlServiceHandler(MgStreamData* data,
...
///////////////////////////////////////////////////////////////////////////
//  <summary>
//  The destructor for the MgKmlServiceHandler object.
//  </summary>
MgKmlServiceHandler::~MgKmlServiceHandler( void )
{
}
...
IMgServiceHandler::MgProcessStatus MgKmlServiceHandler::ProcessOperation()
{
    ...
    handler.reset(MgKmlOperationFactory::GetOperation(
    ...
    MG_CATCH(L"MgKmlServiceHandler.ProcessOperation")
