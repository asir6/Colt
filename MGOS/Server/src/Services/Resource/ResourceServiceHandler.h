...
#ifndef MGRESOURCESERVICEHANDLER_H
#define MGRESOURCESERVICEHANDLER_H
...
class MG_SERVER_RESOURCE_API MgResourceServiceHandler : public IMgServiceHandler
{
public:
    ///////////////////////////////////////////////////////////////////////////
    /// Constructor/Destructor
    MgResourceServiceHandler(MgStreamData* data, const MgOperationPacket& packet);
    virtual ~MgResourceServiceHandler( void );
