...
#ifndef MGRENDERINGSERVICEHANDLER_H
#define MGRENDERINGSERVICEHANDLER_H
...
class MG_SERVER_RENDERING_API MgRenderingServiceHandler : public IMgServiceHandler
{
public:
    ///////////////////////////////////////////////////////////////////////////
    /// Constructor/Destructor
    MgRenderingServiceHandler(MgStreamData* data, const MgOperationPacket& packet);
    virtual ~MgRenderingServiceHandler( void );
