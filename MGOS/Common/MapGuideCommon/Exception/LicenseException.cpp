...
IMPLEMENT_EXCEPTION_DEFAULTS(MgLicenseException, MgSystemException)

///////////////////////////////////////////////////////////////////////////////
/// \brief
/// Construct a MgLicenseException object.
///
MgLicenseException::MgLicenseException(CREFSTRING methodName,
...
/// Destruct the object.
///
MgLicenseException::~MgLicenseException() throw()
{
}
