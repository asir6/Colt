...
throw()
               : DWFResource( L"", DWFXML::kzRole_Font, DWFMIME::kzMIMEType_FONT )
               , _nRequest( nRequest )
...
throw( DWFException )
{
    ...
    if (nFlags & DWFPackageWriter::eDescriptor)
    {
            ...
            //
        {
            ...
            _DWFCORE_SWPRINTF( zTempBuffer, 32, /*NOXLATE*/L"%d", _nRequest );
            rSerializer.addAttribute( DWFXML::kzAttribute_Request, zTempBuffer );
