...
#ifndef _FS_GET_CAPABILITIES_H
#define _FS_GET_CAPABILITIES_H

class MgHttpGetCapabilities : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpGetCapabilities(MgHttpRequest *hRequest);
