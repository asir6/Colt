...
public:
    ...
    DWFResource* findResourceByHREF( const DWFString& zHRef )
       ...
       //
    // Find a resource by it's ObjectID
    //
    _DWFTK_API
    ...
    ///
    _DWFTK_API
    ResourceIterator* removeResourcesByRole( const DWFString& zRole,
                                             bool             bDeleteIfOwned )
        throw( DWFException );
    ...
    ///
    _DWFTK_API
    DWFResource* addResource( DWFResource*       pResource,
                              bool               bOwnResource,
                              bool               bReplace = true,
...
private:
    ...
    DWFResource* _remove( DWFResource* pResource, bool bDeleteIfOwned )
        throw();
...
protected:
    ...
    ///
    typedef multimap<const DWFResource*, DWFResource*> tResourcePointerMultiMap;
