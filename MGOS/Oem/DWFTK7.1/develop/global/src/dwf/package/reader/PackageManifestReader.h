...
///
class DWFManifestReader : public DWFXMLCallback
{
...
public:
    ...
    typedef enum
    {
        ...
        ///
        ///     Equivalent to (eProvideDependencies | eProvideInterfaces | eProvideProperties | eProvideSections )
        ///
        eProvideElements        =   0x3C,
