...
///////////////////////////////////////////////////////////////////////////
void WT_Inked_Area::set_inked_area(WT_Logical_Point const * bounds)
{
    set(bounds);
}
...
///////////////////////////////////////////////////////////////////////////
void WT_Inked_Area::set(WT_Logical_Point const * bounds)
{
    delete []m_bounds;
...
///////////////////////////////////////////////////////////////////////////
WT_Inked_Area::WT_Inked_Area(WT_Inked_Area const & bounds)
    : WT_Attribute()
    , m_materialization_counter(0)
{
    if (bounds.bounds())
...
///////////////////////////////////////////////////////////////////////////
WT_Inked_Area const & WT_Inked_Area::operator=(WT_Inked_Area const & bounds)
{
    delete []m_bounds;
    m_bounds = WD_Null;
