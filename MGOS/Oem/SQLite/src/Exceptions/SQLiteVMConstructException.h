...
#ifndef _SQLITE_VM_CONSTRUCT_EXCEPTION_H
#define _SQLITE_VM_CONSTRUCT_EXCEPTION_H
...
EXTERNAL_API:
    ...
    //////////////////////////////////////////////////////////////////
    ///<summary>
    /// Construct a SQLiteVMConstructException object
    ...
    ///</summary>
    ///
    SQLiteVMConstructException(CREFSTRING methodName, UINT32 lineNumber, CREFSTRING fileName, CREFSTRING message) throw();

    //////////////////////////////////////////////////////////////////
    ///<summary>
    /// Destructor for a SQLiteVMConstructException object
    ///</summary>
    ///
...
#endif //_SQLITE_VM_CONSTRUCT_EXCEPTION_H
