...
#ifndef _HTTP_GET_SELECTION_EXTENT_
#define _HTTP_GET_SELECTION_EXTENT_

class MgHttpGetFeatureSetEnvelope : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpGetFeatureSetEnvelope(MgHttpRequest *hRequest);
...
private:
    STRING  m_featureSetXml;
    STRING  m_mapName;
};

#endif  // _HTTP_GET_SELECTION_EXTENT_
