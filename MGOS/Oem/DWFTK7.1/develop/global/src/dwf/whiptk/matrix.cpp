...
WT_Result WT_Matrix::serialize(WT_File & file) const
{
...
#else
WT_Result WT_Matrix::serialize(WT_File &) const
{
...
///////////////////////////////////////////////////////////////////////////
#if DESIRED_CODE(WHIP_OUTPUT)
WT_Result WT_Matrix::serialize_padded(WT_File & file) const
{
    if (!file.heuristics().allow_binary_data())
    {
        WD_CHECK(file.write_tab_level());
...
#else
WT_Result WT_Matrix::serialize_padded(WT_File &) const
{
    return WT_Result::Success;
}
#endif  // DESIRED_CODE()
...
///////////////////////////////////////////////////////////////////////////
WT_Result WT_Matrix::materialize(WT_File & file)
{
    switch (m_stage)
    {
...
///////////////////////////////////////////////////////////////////////////
WT_Result WT_Matrix::materialize_row(WT_File & file, int row)
{
...
///////////////////////////////////////////////////////////////////////////
WT_Result WT_Matrix2D::serialize( WT_File& file ) const
{
    if( !file.heuristics().allow_binary_data() )
    {
        WD_CHECK(file.write_tab_level());
...
///////////////////////////////////////////////////////////////////////////
WT_Result WT_Matrix2D::materialize( WT_File& file )
{
    WT_Byte a_byte;
    switch( m_stage )
    {
