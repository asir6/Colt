...
public:
    ...
    typedef enum
    {
		...
		///
        ///     Equivalent to (eProvideUnits | eProvideProperties | eProvideResources | eProvideUntypedResource | eProvideFontResource | eProvideGraphicResource | eProvideImageResource)
        ///
...
public:
    ...
    ///
    _DWFTK_API
    virtual DWFUnits* provideUnits( DWFUnits* pPaper )
        throw();
