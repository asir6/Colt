...
template class SQLITE_API basic_string<XMLCh, unicode_traits<XMLCh> >;
template class SQLITE_API basic_string<LCh, unicode_traits<LCh> >;
...
class SQLITE_API UnicodeString
{
public:
