...
#ifndef MGRESOURCEOPERATION_H_
#define MGRESOURCEOPERATION_H_

#include "ServiceOperation.h"
#include "ServerResourceService.h"

class MgResourceOperation : public MgServiceOperation
{
...
inline MgService* MgResourceOperation::GetService()
{
