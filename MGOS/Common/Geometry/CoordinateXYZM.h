...
/// abstract class MgCoordinate.
///
/// \remarks
/// It has no public constructor.
/// Instances are created by calling the non-static
...
INTERNAL_API:
    ...
    ///
    MgCoordinateXYZM(double x, double y, double z, double m);
