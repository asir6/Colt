...
#include "HttpGetRepositoryHeader.h"

HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpGetRepositoryHeader)
...
/// nothing
/// </returns>
MgHttpGetRepositoryHeader::MgHttpGetRepositoryHeader(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpGetRepositoryHeader::Execute(MgHttpResponse& hResponse)
{
