...
#ifndef MGHTTPMOVERESOURCE_H_
#define MGHTTPMOVERESOURCE_H_

class MgHttpMoveResource : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpMoveResource(MgHttpRequest *hRequest);
