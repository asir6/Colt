...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpCsConvertWktToEpsgCode)
...
/// nothing
/// </returns>
MgHttpCsConvertWktToEpsgCode::MgHttpCsConvertWktToEpsgCode(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpCsConvertWktToEpsgCode::Execute(MgHttpResponse& hResponse)
{
    ...
    MG_HTTP_HANDLER_CATCH_AND_THROW_EX(L"MgHttpCsConvertWktToEpsgCode.Execute")
}
