...
#ifndef _FS_GET_LEGEND_IMAGE_H
#define _FS_GET_LEGEND_IMAGE_H

class MgHttpGetLegendImage : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpGetLegendImage(MgHttpRequest *hRequest);
...
private:
    ...
    STRING m_format;
    INT32 m_type;
    INT32 m_themeCategory;
};

#endif  // _FS_GET_LEGEND_IMAGE_H
