...
///////////////////////////////////////////////////////////////////////////
size_t WT_String::wcslen (WT_Unsigned_Integer16 const * string) {
...
///////////////////////////////////////////////////////////////////////////
WT_String::WT_String( WT_String const & string )
...
///////////////////////////////////////////////////////////////////////////
WT_String::WT_String( WT_Unsigned_Integer16 const * string )
: m_stage(Eating_Initial_Whitespace)
, m_string_type(Not_Yet_Scanned)
, m_length(0)
, m_string(WD_Null)
...
///////////////////////////////////////////////////////////////////////////
WT_String::WT_String( WT_Byte const * string )
: m_stage(Eating_Initial_Whitespace)
...
///////////////////////////////////////////////////////////////////////////
WT_String::WT_String( char const * string )
: m_stage(Eating_Initial_Whitespace)
, m_string_type(Only_ASCII)
, m_length(0)
, m_string(WD_Null)
...
///////////////////////////////////////////////////////////////////////////
WT_String::WT_String(int length, WT_Unsigned_Integer16 const * string)
: m_stage(Eating_Initial_Whitespace)
, m_string_type(Not_Yet_Scanned)
, m_length(0)
, m_string(WD_Null)
...
///////////////////////////////////////////////////////////////////////////
WT_String::WT_String(int length, WT_Byte const * string)
: m_stage(Eating_Initial_Whitespace)
, m_string_type(Not_Yet_Scanned)
, m_length(0)
, m_string(WD_Null)
...
///////////////////////////////////////////////////////////////////////////
WT_String::WT_String(int length, char const * string)
: m_stage(Eating_Initial_Whitespace)
, m_string_type(Not_Yet_Scanned)
, m_length(0)
, m_string(WD_Null)
...
///////////////////////////////////////////////////////////////////////////
WT_String const & WT_String::operator= (WT_String const & string)
{
    set(string);
    return *this;
}
...
///////////////////////////////////////////////////////////////////////////
void WT_String::set(int length, char const * string)
{
    set(length,(WT_Byte const*)string);
}

///////////////////////////////////////////////////////////////////////////
void WT_String::set(int length, WT_Byte const * string)
{
...
///////////////////////////////////////////////////////////////////////////
void WT_String::set(int length, WT_Unsigned_Integer16 const * string)
{
    *this = WT_String::kNull;
    if(!string)
        return;
...
///////////////////////////////////////////////////////////////////////////
void WT_String::set( WT_String const & string )
{
...
///////////////////////////////////////////////////////////////////////////
WT_Byte * WT_String::to_ascii( int length, WT_Unsigned_Integer16 const * string )
{
...
///////////////////////////////////////////////////////////////////////////
WT_Unsigned_Integer16 * WT_String::to_unicode( int length, WT_Byte const * string )
{
