...
#ifndef _FS_GET_MAP_IMAGE_H
#define _FS_GET_MAP_IMAGE_H

class MgHttpGetMapImage : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpGetMapImage(MgHttpRequest *hRequest);
