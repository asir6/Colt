...
#ifndef _IOAREATYPESTYLE_H
#define _IOAREATYPESTYLE_H
...
class IOAreaTypeStyle : public SAX2ElementHandler
{
    public:
        IOAreaTypeStyle(Version& version);
