...
#ifndef MG_INVALID_DWF_PACKAGE_EXCEPTION_H_
#define MG_INVALID_DWF_PACKAGE_EXCEPTION_H_
...
///
class MG_MAPGUIDE_API MgInvalidDwfPackageException : public MgApplicationException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = MapGuide_Exception_MgInvalidDwfPackageException;
};
