...
#ifndef _FS_SELECT_FEATURES_H
#define _FS_SELECT_FEATURES_H

class MgHttpSelectFeatures : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpSelectFeatures(MgHttpRequest *hRequest);
