...
#ifndef _MGHTTPENUMAPPWIDGETS_H_
#define _MGHTTPENUMAPPWIDGETS_H_

#include <vector>
using namespace std;

class MgHttpEnumerateApplicationWidgets : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpEnumerateApplicationWidgets(MgHttpRequest *hRequest);
...
#endif  //_MGHTTPENUMAPPWIDGETS_H_
