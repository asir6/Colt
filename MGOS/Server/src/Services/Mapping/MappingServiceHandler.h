...
#ifndef MGMAPPINGSERVICEHANDLER_H
#define MGMAPPINGSERVICEHANDLER_H
...
class MG_SERVER_MAPPING_API MgMappingServiceHandler : public IMgServiceHandler
{
public:
    ///////////////////////////////////////////////////////////////////////////
    /// Constructor/Destructor
    MgMappingServiceHandler(MgStreamData* data, const MgOperationPacket& packet);
    virtual ~MgMappingServiceHandler( void );
