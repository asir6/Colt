...
#ifndef _SQLITE_PREPARE_EXCEPTION_H
#define _SQLITE_PREPARE_EXCEPTION_H
...
EXTERNAL_API:
    ...
    //////////////////////////////////////////////////////////////////
    ///<summary>
    /// Construct a SQLitePrepareException object
    ...
    ///</summary>
    ///
    SQLitePrepareException(CREFSTRING methodName, UINT32 lineNumber, CREFSTRING fileName, CREFSTRING message) throw();

    //////////////////////////////////////////////////////////////////
    ///<summary>
    /// Destructor for a SQLitePrepareException object
    ///</summary>
    ///
...
#endif //_SQLITE_PREPARE_EXCEPTION_H
