...
/** \mainpage
 *  <b><font size=+1><p>By using this code, you are agreeing to the terms and conditions of
 *  the \ref license "License Agreement" included in the documentation for this code.</p>
 *  <p>This publication, or parts thereof, may not be reproduced in any form, by any method,
 *  except as granted by the \ref license "License Agreement". </p></font></b>
 *
 *  \htmlinclude "Disclaimer.html"
 *
 *  \section usersGuideLink User's Guide
 *  \link WHIPusersGuidePage \htmlonly <blockquote>Click here for the WHIP! Toolkit User's Guide.</blockquote> \endhtmlonly \endlink
 *
 *  \section trademarks Trademarks
 *  \htmlinclude "Trademarks.html"
 *
 *  \section license License Agreement
 *  \htmlinclude "LicenseAgreement.html"
 *
 *  \section acknowledgements Acknowledgements
 *  \htmlinclude "Acknowledgements.html"
 */
