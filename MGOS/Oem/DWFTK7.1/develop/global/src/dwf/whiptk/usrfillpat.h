...
public:
    ...
    public:
        ...
        static Fill_Pattern* Construct (
            ...
            WT_Unsigned_Integer16    columns, /**< Width of the bitonal bitmap in pixels. */                    WT_Unsigned_Integer32    data_size = 0, /**< The size (in bytes) of the raw image data contained in the \a data argument. */
        ...
        {   return m_data; }
        /// Comparison operator 
        WT_Boolean operator == ( Fill_Pattern const &  );
    ...
    protected:
        ...
        Fill_Pattern( WT_Unsigned_Integer16    rows, /**< Height of the bitonal bitmap in pixels. */
                      WT_Unsigned_Integer16    columns, /**< Width of the bitonal bitmap in pixels. */                         WT_Unsigned_Integer32    data_size, /**< The size (in bytes) of the raw image data contained in the \a data argument. */
...
public:
    ...
    WT_Integer16 pattern_number() const
...
private:
    ...
    struct WT_User_Fill_Pattern_Option_Code
