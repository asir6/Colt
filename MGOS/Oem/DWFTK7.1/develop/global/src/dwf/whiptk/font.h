...
public:
     ...
     *  @{
     */
    WT_Font_Option_Charset & charset()         { return m_option_charset; }
    WT_Font_Option_Family & family()           { return m_option_family; }
    WT_Font_Option_Flags & flags()             { return m_option_flags; }
    WT_Font_Option_Font_Name & font_name()     { return m_option_font_name; }
    WT_Font_Option_Height & height()           { return m_option_height; }
    WT_Font_Option_Oblique & oblique()         { return m_option_oblique; }
    WT_Font_Option_Pitch & pitch()             { return m_option_pitch; }
    WT_Font_Option_Rotation & rotation()       { return m_option_rotation; }
    WT_Font_Option_Spacing & spacing()         { return m_option_spacing; }
    WT_Font_Option_Style & style()             { return m_option_style; }
    WT_Font_Option_Width_Scale & width_scale() { return m_option_width_scale;}
    //@}
