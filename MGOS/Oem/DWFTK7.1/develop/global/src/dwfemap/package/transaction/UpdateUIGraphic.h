...
//
#ifndef _DWFEMAPTK_UPDATEUIGRAPHIC_H
#define _DWFEMAPTK_UPDATEUIGRAPHIC_H
...
namespace DWFToolkit { namespace DWFEMapExtension
{
    //--------------------------------------------------------------------
    // DESCRIPTION:
    // The class DWFEMapUpdateUIGraphicCommand... TODO.
    //--------------------------------------------------------------------
    class DWFEMapUpdateUIGraphicCommand : public DWFEMapCommand
    {
    public:
        // constructor used with XMLBuildable
        _DWFTK_API DWFEMapUpdateUIGraphicCommand() throw();

        // basic constructor
        _DWFTK_API DWFEMapUpdateUIGraphicCommand(const DWFString& zObjectID,
        ...
        // destructor
        _DWFTK_API  virtual ~DWFEMapUpdateUIGraphicCommand() throw();
    ...
    private:
        ...
        // state variable for processing the XML data
        bool _bProcessLabel;
    };
}}

#endif // _DWFEMAPTK_UPDATEUIGRAPHIC_H
// End of file.
