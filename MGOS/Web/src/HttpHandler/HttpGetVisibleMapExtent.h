...
#ifndef _FS_GET_VISIBLE_MAP_EXTENT_H
#define _FS_GET_VISIBLE_MAP_EXTENT_H

class MgHttpGetVisibleMapExtent : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpGetVisibleMapExtent(MgHttpRequest *hRequest);
