...
#ifndef MGFEATURESERVICEHANDLER_H
#define MGFEATURESERVICEHANDLER_H
...
class MG_SERVER_FEATURE_API MgFeatureServiceHandler : public IMgServiceHandler
{
public:
    ///////////////////////////////////////////////////////////////////////////
    /// Constructor/Destructor
    MgFeatureServiceHandler(MgStreamData* data, const MgOperationPacket& packet);
    virtual ~MgFeatureServiceHandler( void );
