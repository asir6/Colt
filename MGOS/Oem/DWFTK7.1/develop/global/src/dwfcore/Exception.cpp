            ...
            , _nLine( nLine )
{
	...
	if (zMessage)
	{
		size_t nBytes = dwf_min( 511*sizeof(wchar_t), DWFCORE_WIDE_STRING_LENGTH_IN_BYTES(zMessage) );
            ...
            , _nLine( rEx._nLine )
{
	...
	if (rEx._zMessage)
	{
		size_t nBytes = dwf_min( 511*sizeof(wchar_t), DWFCORE_WIDE_STRING_LENGTH_IN_BYTES(rEx._zMessage) );
