...
///////////////////////////////////////////////////////////////////////////
WT_Text_Background::WT_Text_Background(WT_Background background,
                                       WT_Integer32 offset)
...
///////////////////////////////////////////////////////////////////////////
WT_Text_Background::WT_Background WT_Text_Background::background()
{
...
///////////////////////////////////////////////////////////////////////////
WT_Integer32 WT_Text_Background::offset()
{
    return m_offset;
}

///////////////////////////////////////////////////////////////////////////
void WT_Text_Background::set_Background(WT_Background background)
{
    m_eBackground = background;
}

///////////////////////////////////////////////////////////////////////////
void WT_Text_Background::set_Offset(WT_Integer32 offset)
{
    m_offset = offset;
}
        ...
        case WT_Opcode::Extended_Binary:
            {
                ...
                {
                    m_eBackground = (WT_Background)eValue;
                }
                else
                {
                    m_eBackground = WT_Text_Background::None;
...
///////////////////////////////////////////////////////////////////////////
const char* WT_Text_Background::enum_to_string(WT_Background background)
{
