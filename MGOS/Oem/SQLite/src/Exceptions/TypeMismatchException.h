...
#ifndef _TYPE_MISMATCH_EXCEPTION_H
#define _TYPE_MISMATCH_EXCEPTION_H
...
EXTERNAL_API:
    ...
    //////////////////////////////////////////////////////////////////
    ///<summary>
    /// Construct a TypeMismatchException object
    ...
    ///</summary>
    ///
    TypeMismatchException(CREFSTRING methodName, UINT32 lineNumber, CREFSTRING fileName, CREFSTRING message) throw();

    //////////////////////////////////////////////////////////////////
    ///<summary>
    /// Destructor for a TypeMismatchException object
    ///</summary>
    ///
...
#endif //_TYPE_MISMATCH_EXCEPTION_H
