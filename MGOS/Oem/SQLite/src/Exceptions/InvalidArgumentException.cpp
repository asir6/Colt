...
IMPLEMENT_EXCEPTION_DEFAULTS(InvalidArgumentException, SqliteException)

//////////////////////////////////////////////////////////////////
/// <summary>
/// Constructs a InvalidArgumentException with the specified method name, line number and file name.
/// </summary>
InvalidArgumentException::InvalidArgumentException(CREFSTRING methodName, UINT32 lineNumber, CREFSTRING fileName, CREFSTRING message) throw():
