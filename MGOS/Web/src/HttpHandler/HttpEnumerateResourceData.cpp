...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpEnumerateResourceData)
...
/// nothing
/// </returns>
MgHttpEnumerateResourceData::MgHttpEnumerateResourceData(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpEnumerateResourceData::Execute(MgHttpResponse& hResponse)
{
    ...
    // Run API command
    Ptr<MgByteReader> byteReader = mgprService->EnumerateResourceData(&mgrIdentifier);
    ...
    MG_HTTP_HANDLER_CATCH_AND_THROW_EX(L"MgHttpEnumerateResourceData.Execute")
}
