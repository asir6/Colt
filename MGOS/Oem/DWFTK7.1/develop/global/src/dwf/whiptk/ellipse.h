...
public:
    ...
    WT_Integer32 major() const
    {
        return m_major;
    }

    /// Returns the minor axis radius.
    WT_Integer32 minor() const
    {
        return m_minor;
    }

    /// Returns the center point of the ellipse.
    WT_Logical_Point position() const
    {
        return m_position;
    }

    /// Returns the start angle (in 360/65,536ths of a degree.)
    WT_Unsigned_Integer16 start() const
    {
        return m_start;
    }
    ...
    WT_Unsigned_Integer32 end() const
    {
        return m_end;
    }
    ...
    WT_Unsigned_Integer16 tilt() const
    {
        return m_tilt;
    }
