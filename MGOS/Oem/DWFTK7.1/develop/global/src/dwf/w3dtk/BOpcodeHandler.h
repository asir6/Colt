...
/*!
    ...
    excecution and interpretation of HOOPS Stream File information.  Execution refers to the process of populating application-specific data
    ...
    attributes, and geometric primimtives.
    ...
    (When using HoopsStream, the GenerateBuffer method of the HStreamFileToolkit encapsualetes this process.  However,
    if BaseStream is used, the Interpret/Write process must be performed manually.)
*/
class BBINFILETK_API BBaseOpcodeHandler : public BControlledMemoryObject
                                        , public W3DOpcodeHandler
{
    ...
    public:
        /*!
           Default constructor for an BBaseOpcodeHandler object
                   \param op Character denoting the opcode that the object supports.  This is necessary for opcode handlers that
                   support more than one opcode, such as TK_Polypoint, which supports both TKE_Polygon and TKE_Polyline opcodes.
        */
        BBaseOpcodeHandler (unsigned char op)
            : m_stage (0), m_progress (0), m_opcode (op),
    ...
    /*!
        ...
        */
        bool                Tagging (BStreamFileToolkit & tk) const   { return tk.GetWriteFlags(TK_Force_Tags) != 0; }
  ...
  #define UNREFERENCED(x) (void)(x)
        ...
        */
        ...
        void        Remember_Segment (BStreamFileToolkit & tk, ID_Key key) const  { tk.remember_segment(key); }
        /*! Determines if a segment has already been processed (avoid multiple writes of inclusions) */
        bool        Find_Segment (BStreamFileToolkit & tk, ID_Key key) const      { return tk.find_segment(key); }
...
class BBINFILETK_API TK_Default : public BBaseOpcodeHandler {
    public:
        /*! constructor */
        TK_Default () : BBaseOpcodeHandler (0) {}
...
class BBINFILETK_API TK_Header : public BBaseOpcodeHandler {
    ...
    public:
        /*! constructor */
        TK_Header () : BBaseOpcodeHandler (0), m_current_object (0) {}
        ~TK_Header();
...
class BBINFILETK_API TK_Terminator : public BBaseOpcodeHandler {
    ...
    public:
        /*! constructor */
        TK_Terminator (char opcode) : BBaseOpcodeHandler (opcode) {}
...
//! Handles the TKE_Renumber_Key_Global and TKE_Renumber_Key_Local opcodes.
/*!
...
enum TKO_Geometry_Bits {
    ...
    TKO_Geo_Text_Contrast   = 0x00100000, //!< extra item for color; refer to ::HC_Set_Color for a description
    TKO_Geo_All_Colors      = 0x001FFFFF, //!< extra item for color; refer to ::HC_Set_Color for a description
    ...
    TKO_Geo_Geom_Selects    = 0x000043DF, //!< extra item for selectability; refer to ::HC_Set_Selectability for a description
    ...
    TKO_Geo_Edge_Visibles   = 0x0000F002, //!< extra item for visibility; refer to ::HC_Set_Visibility for a description
    ...
    TKO_Geo_Geom_Visibles   = 0x0001FFFF, //!< extra item for visibility; refer to ::HC_Set_Visibility for a description
    ...
    TKO_Geo_Extended2       = 0x00800000, //!< secondary extened bits
    TKO_Geo_Extended2_Mask  = 0xFF000000, //!< internal use, indicates bits which require TKO_Geo_Extended2

    TKO_Geo_All_Visibles    = 0x002FFFFF  //!< extra item for visibility; refer to ::HC_Set_Visibility for a description
};
...
class BBINFILETK_API TK_Color : public BBaseOpcodeHandler {
    private:
        TK_Color(const TK_Color&);
        TK_Color& operator=(const TK_Color&);
    ...
    protected:
        ...
        */
        ...
        //! internal use
        void    set_channel_rgb (channel alter & c, float r, float g, float b, int channel = -1) alter {
                        c.m_rgb[0] = r;     c.m_rgb[1] = g;     c.m_rgb[2] = b;
                        if (channel != -1) {
                            m_channels |= (1 << channel);
			    if (channel > TKO_Channel_Extended)
				m_channels |= (1 << TKO_Channel_Extended);
			}
                    }
        //! internal use
        void    set_channel_name (channel alter & c, char const * name, int channel = -1) alter;
        //! internal use
        void    set_channel_name (channel alter & c, int length, int channel = -1) alter;
    ...
    public:
        ...
        void            SetDiffuse (float r, float g, float b) alter    { set_channel_rgb (m_diffuse, r, g, b); }
        ...
        void            SetSpecular (float r, float g, float b) alter   { set_channel_rgb (m_specular, r, g, b);}
        ...
        void            SetMirror (float r, float g, float b) alter     { set_channel_rgb (m_mirror, r, g, b);  }
        ...
        void            SetTransmission (float r, float g, float b) alter { set_channel_rgb (m_transmission, r, g, b); }
        ...
        void            SetEmission (float r, float g, float b) alter   { set_channel_rgb (m_emission, r, g, b);}
...
class BBINFILETK_API TK_Color_Map : public BBaseOpcodeHandler {
    ...
    public:
        /*! constructor */
        TK_Color_Map ()
            : BBaseOpcodeHandler (TKE_Color_Map), m_length (0), m_format (TKO_Map_RGB_Values) {}
...
#define TKO_Rendo_Extended                0x80000000
    ...
    TKO_Transparency_None               = 0,   //!< type for transparency field; refer to ::HC_Set_Rendering_Options for description
    TKO_Transparency_Blending           = 1,   //!< type for transparency field; refer to ::HC_Set_Rendering_Options for description
    TKO_Transparency_Screen_Door        = 2,   //!< type for transparency field; refer to ::HC_Set_Rendering_Options for description
    ...
    TKO_Simple_Shadow_Light_Direction	= 0x0008,   //!< type for 'imple shadow' field; refer to ::HC_Set_Rendering_Options for description
    ...
    TKO_NURBS_Curve_Mask                = 0x000F,    //!< type for NURBS curve options; refer to ::HC_Set_Rendering_Options for description
    ...
    TKO_NURBS_Extended_Mask		= 0xFF00,  //!< indicates that the 2nd byte should be written
    ...
    TKO_NURBS_Surface_Mask              = 0x07F0,    //!< type for NURBS curve options; refer to ::HC_Set_Rendering_Options for description
...
class BBINFILETK_API TK_Rendering_Options : public BBaseOpcodeHandler {
    ...
    float       m_surface_max_facet_width;//!< For internal use only.
        ...
        unsigned char   m_transparency_options; //!< internal use; low half style, high half hardware flag
    ...
    public:
        ...
        */
        ...
        /*! Sets the simple shadow blur image resolution. */
        void            SetSimpleShadowResolution (int m) alter	    { m_simple_shadow_resolution = (unsigned char)m;  }
        /*! Returns simple shadow blur image resolution. */
...
enum TKO_Heuristic_Bits {
    ...
    TKO_Heuristic_Internal_Select_Limit = 0x00000080,  //!< refer to ::HC_Set_Heuristics
    ...
    TKO_Heuristic_Extended_Mask         = 0xFFFF0000,  // internal use, indicates bits which require TKO_Heuristic_Extended
    ...
    TKO_Heur_View_Frustum_Culling       = 0x01,  //!< refer to ::HC_Set_Heuristics
    TKO_Heur_Obscuration_Culling        = 0x02  //!< refer to ::HC_Set_Heuristics
};
...
class BBINFILETK_API TK_Heuristics : public BBaseOpcodeHandler {
    ...
    public:
        ...
        void            SetInternalSelectionLimit (int i) alter { m_internal = i;     }
        /*! Returns the internal selection limit */
        int             GetInternalSelectionLimit (void) const  { return m_internal;  }
        ...
        void            SetCulling (int c) alter        { m_culling = (unsigned char)c; }
...
class BBINFILETK_API TK_Visibility : public BBaseOpcodeHandler {
    private:
        TK_Visibility(const TK_Visibility&);
        TK_Visibility& operator=(const TK_Visibility&);
...
class BBINFILETK_API TK_Matrix : public BBaseOpcodeHandler {
    private:
        TK_Matrix(const TK_Matrix&);
        TK_Matrix& operator=(const TK_Matrix&);
...
class BBINFILETK_API TK_User_Index : public BBaseOpcodeHandler {
    ...
    public:
        /*! constructor */
        TK_User_Index ()
            : BBaseOpcodeHandler (TKE_User_Index), m_count (0), m_indices (0), m_values (0) {}
        ~TK_User_Index();
...
*/
class BBINFILETK_API TK_Camera : public BBaseOpcodeHandler {
    private:
...
*/
enum TKO_Font_Options {
    TKO_Font_Names              = 0x0001,   //!< the name of the font (i.e. which font to use)
    TKO_Font_Size               = 0x0002,   //!< the size at which to draw characters
    TKO_Font_Size_Tolerance     = 0x0004,   //!< the size tolerance outside of which fonts must be regenerated
    TKO_Font_Transforms         = 0x0008,   //!< transformation mode (set with a bit from TKO_Font_Transforms)
    TKO_Font_Rotation           = 0x0010,   //!< character rotation, specified in degrees
    TKO_Font_Slant              = 0x0020,   //!< character slant
    TKO_Font_Width_Scale        = 0x0040,   //!< scale factor for width
    TKO_Font_Extended           = 0x0080,   //!< extends font options to a second byte
    TKO_Font_Extended_Mask      = 0xFF00,   //   internal use, indicates bits which require TKO_Font_Extended
    TKO_Font_Extra_Space        = 0x0100,   //!< in addition to the spacing specified within the font itself, the extra space to add between characters
    TKO_Font_Line_Spacing       = 0x0200,   //!< extra spacing between lines
    TKO_Font_Outline            = 0x0400,   //!< draw only the outline (i.e. don't fill)
    TKO_Font_Underline          = 0x0800,   //!< add an underline to the font
    TKO_Font_Strikethrough      = 0x1000,   //!< add a strikethrough to the font
    TKO_Font_Overline           = 0x2000    //!< add an overline to the font
};
...
/*!
    ...
    The HOOPS/3dGS scene-graph maintian bounding volume information which denotes the extents of the scene.
...
//! Handles the TKE_Bounding, and TKE_Bounding_Info opcodes.
/*!
    TK_Point provides support for writing/reading the TKE_Bounding TKE_Bounding_Info opcode objects to/from an HSF file.
...
*/
class BBINFILETK_API TK_Bounding : public BBaseOpcodeHandler {
    private:
...
class BBINFILETK_API TK_Point : public BBaseOpcodeHandler {
	...
	void	    Reset(void) { 
        ...
        /*! Sets the light option. Options are specified in #TKO_Light_Options */
        void            SetOption (char o) alter                    { m_options = o;                }
        /*! Returns the light option. Options are specified in #TKO_Light_Options */
        char            GetOption (void) const                      { return m_options;             }
};
...
class BBINFILETK_API TK_Cutting_Plane : public BBaseOpcodeHandler {
    private:
        TK_Cutting_Plane(const TK_Cutting_Plane&);
        TK_Cutting_Plane& operator=(const TK_Cutting_Plane&);

    protected:
        float           m_plane[4];     //!< internal use

    public:
        /*! constructor */
        TK_Cutting_Plane ()
            : BBaseOpcodeHandler (TKE_Cutting_Plane) {}
        ...
        void            SetPlane (float a, float b, float c, float d) alter
                                    { m_plane[0] = a;  m_plane[1] = b;  m_plane[2] = c;  m_plane[3] = d;    }
        /*! Sets the cutting plane using an array of four floats */
        void            SetPlane (float const * p) alter            { SetPlane (p[0], p[1], p[2], p[3]);    }
        /*! Returns the cutting plane as the address of an array of four floats */
        float const *   GetPlane (void) const                       { return m_plane;                       }
};
...
class BBINFILETK_API TK_Circle : public BBaseOpcodeHandler {
    ...
    public:
        ...
        void            SetStart (float const * s) alter {
                                m_start[0] = s[0];  m_start[1] = s[1];  m_start[2] = s[2];
                            }
        ...
        void            SetMiddle (float const * m) alter {
                                m_middle[0] = m[0]; m_middle[1] = m[1]; m_middle[2] = m[2];
                            }
        ...
        void            SetEnd (float const * e) alter {
                                m_end[0] = e[0];    m_end[1] = e[1];    m_end[2] = e[2];
                            }
        ...
        void            SetPoints (float const * s, float const * m, float const * e) alter {
                                SetStart (s); SetMiddle (m); SetEnd (e);
                            }
...
class BBINFILETK_API TK_Image_Data_Buffer {
    protected:
...
class BBINFILETK_API TK_Image : public BBaseOpcodeHandler {
	...
	unsigned char		m_explicit_units[2];	/*!< internal use; non-pixel units */
        TK_Image_Data_Buffer    m_work_area;    /*!< internal use; Buffer for compression data */
...
*/
class BBINFILETK_API TK_Texture : public BBaseOpcodeHandler {
    private:
...
*/
class BBINFILETK_API TK_Thumbnail : public BBaseOpcodeHandler {
private:
...
*/
class BBINFILETK_API TK_Glyph_Definition : public BBaseOpcodeHandler {
private:
...
*/
class BBINFILETK_API TK_Line_Style : public BBaseOpcodeHandler {
private:
...
*/
class BBINFILETK_API TK_User_Data : public BBaseOpcodeHandler {
    private:
    ...
    public:
        /*! constructor */
        TK_User_Data ()
            : BBaseOpcodeHandler (TKE_Start_User_Data), m_size (0), m_data (0) {}
        ~TK_User_Data();
...
///\since       1.0.1000
///
///             This class has been added to handle the extended W3DE_Image op-code.
...
class BBINFILETK_API W3D_Image : public BBaseOpcodeHandler
{
    ...
    public:
        /*! constructor */
        W3D_Image () : BBaseOpcodeHandler ((unsigned char)W3DE_Image), m_name (0), m_name_length (0), m_bpp(0)
        { m_size[0] = m_size[1] = 0; }
        ~W3D_Image();
