...
#ifndef _FS_GET_TILE_IMAGE_H
#define _FS_GET_TILE_IMAGE_H

class MgHttpGetTileImage : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpGetTileImage(MgHttpRequest *hRequest);
