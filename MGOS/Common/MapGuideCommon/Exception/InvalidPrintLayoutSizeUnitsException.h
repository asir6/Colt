...
#ifndef MG_INVALID_PRINT_LAYOUT_SIZE_UNITS_EXCEPTION_H_
#define MG_INVALID_PRINT_LAYOUT_SIZE_UNITS_EXCEPTION_H_
...
///
class MG_MAPGUIDE_API MgInvalidPrintLayoutSizeUnitsException : public MgApplicationException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = MapGuide_Exception_MgInvalidPrintLayoutSizeUnitsException;
};
