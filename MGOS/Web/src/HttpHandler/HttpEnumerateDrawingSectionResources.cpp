...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpEnumerateDrawingSectionResources)
...
/// nothing
/// </returns>
MgHttpEnumerateDrawingSectionResources::MgHttpEnumerateDrawingSectionResources(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpEnumerateDrawingSectionResources::Execute(MgHttpResponse& hResponse)
{
