...
//
#ifndef _DWFEMAPTK_REMOVELAYERGROUP_H
#define _DWFEMAPTK_REMOVELAYERGROUP_H
...
namespace DWFToolkit { namespace DWFEMapExtension
{
    //--------------------------------------------------------------------
    // DESCRIPTION:
    // The class DWFEMapRemoveLayerGroupCommand... TODO.
    //--------------------------------------------------------------------
    class DWFEMapRemoveLayerGroupCommand : public DWFEMapCommand
    {
    public:
        // constructor used with XMLBuildable
        _DWFTK_API DWFEMapRemoveLayerGroupCommand() throw();

        // basic constructor
        _DWFTK_API DWFEMapRemoveLayerGroupCommand(const DWFString& zObjectID) throw();
        ...
        // destructor
        _DWFTK_API virtual ~DWFEMapRemoveLayerGroupCommand() throw();
...
#endif // _DWFEMAPTK_REMOVELAYERGROUP_H
// End of file.
