...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpGetDwfViewerPage)
...
/// nothing
/// </returns>
MgHttpGetDwfViewerPage::MgHttpGetDwfViewerPage(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpGetDwfViewerPage::Execute(MgHttpResponse& hResponse)
{
