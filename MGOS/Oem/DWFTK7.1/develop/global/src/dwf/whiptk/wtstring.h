...
public:
    ...
    static size_t wcslen (WT_Unsigned_Integer16 const * string);
    ...
    void               set( int length, WT_Unsigned_Integer16 const * string );
    /// Sets the string from a null-terminated ASCII character string buffer for the specified length.
    void               set( int length, WT_Byte const * string );
    /// Sets the string from a null-terminated ASCII character string buffer for the specified length.
    void               set( int length, char const * string );
