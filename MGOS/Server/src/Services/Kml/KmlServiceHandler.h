...
#ifndef MGKMLSERVICEHANDLER_H
#define MGKMLSERVICEHANDLER_H
...
class MG_SERVER_KML_API MgKmlServiceHandler : public IMgServiceHandler
{
public:
    ///////////////////////////////////////////////////////////////////////////
    /// Constructor/Destructor
    MgKmlServiceHandler(MgStreamData* data, const MgOperationPacket& packet);
    virtual ~MgKmlServiceHandler( void );
