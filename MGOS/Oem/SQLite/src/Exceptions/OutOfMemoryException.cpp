...
IMPLEMENT_EXCEPTION_DEFAULTS(OutOfMemoryException, SqliteException)

//////////////////////////////////////////////////////////////////
/// <summary>
/// Constructs a OutOfMemoryException with the specified method name, line number and file name.
/// </summary>
OutOfMemoryException::OutOfMemoryException(CREFSTRING methodName, UINT32 lineNumber, CREFSTRING fileName, CREFSTRING message) throw():
