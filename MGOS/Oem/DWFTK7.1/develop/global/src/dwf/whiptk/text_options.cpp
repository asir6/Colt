...
void WT_Text_Option_Scoring::set(WT_Unsigned_Integer16 count, WT_Unsigned_Integer16 const * pos)
{
    m_count = count;
...
///////////////////////////////////////////////////////////////////////////
WT_Text_Option_Scoring::WT_Text_Option_Scoring(WT_Text_Option_Scoring const & scoring)
  : WT_Option()
...
///////////////////////////////////////////////////////////////////////////
WT_Text_Option_Scoring const & WT_Text_Option_Scoring::operator= (WT_Text_Option_Scoring const & scoring)
{
    delete []m_positions;
    m_positions = WD_Null;
...
///////////////////////////////////////////////////////////////////////////
void WT_Text_Option_Bounds::set(WT_Logical_Point const * bounds)
{
    delete []m_bounds;
...
///////////////////////////////////////////////////////////////////////////
WT_Text_Option_Bounds::WT_Text_Option_Bounds(WT_Text_Option_Bounds const & bounds)
  : WT_Option()
  , m_materialization_counter(0)
{
    if (bounds.bounds())
...
///////////////////////////////////////////////////////////////////////////
WT_Text_Option_Bounds const & WT_Text_Option_Bounds::operator= (WT_Text_Option_Bounds const & bounds)
{
    delete []m_bounds;
    m_bounds = WD_Null;
...
//========================================================================================
//========================================================================================
void WT_Text_Option_Reserved::set(WT_Unsigned_Integer16 count, WT_Unsigned_Integer16 const * values)
{
    m_count = count;
...
///////////////////////////////////////////////////////////////////////////
WT_Text_Option_Reserved::WT_Text_Option_Reserved(WT_Text_Option_Reserved const & reserved)
  : WT_Option()
...
///////////////////////////////////////////////////////////////////////////
WT_Text_Option_Reserved const & WT_Text_Option_Reserved::operator= (WT_Text_Option_Reserved const & reserved)
{
    delete []m_values;
    m_values = WD_Null;
