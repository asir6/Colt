...
//
//  <summary>
//  Constructs a MgRenderingServiceHandler object with the given parameters.
//  </summary>
//
//  <param name = "data">
...
//  data stream.
//  </param>
MgRenderingServiceHandler::MgRenderingServiceHandler(MgStreamData* data,
...
///////////////////////////////////////////////////////////////////////////
//  <summary>
//  The destructor for the MgRenderingServiceHandler object.
//  </summary>
MgRenderingServiceHandler::~MgRenderingServiceHandler( void )
{
}
...
IMgServiceHandler::MgProcessStatus MgRenderingServiceHandler::ProcessOperation()
{
    ...
    handler.reset(MgRenderingOperationFactory::GetOperation(
    ...
    MG_CATCH(L"MgRenderingServiceHandler.ProcessOperation")
