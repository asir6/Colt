...
//
#ifndef _DWFEMAPTK_UPDATELAYERGROUP_H
#define _DWFEMAPTK_UPDATELAYERGROUP_H
...
namespace DWFToolkit { namespace DWFEMapExtension
{
    //--------------------------------------------------------------------
    // DESCRIPTION:
    // The class DWFEMapUpdateLayerGroupCommand... TODO.
    //--------------------------------------------------------------------
    class DWFEMapUpdateLayerGroupCommand : public DWFEMapCommand
    {
    public:
        // constructor used with XMLBuildable
        _DWFTK_API DWFEMapUpdateLayerGroupCommand() throw();

        // basic constructor
        _DWFTK_API DWFEMapUpdateLayerGroupCommand(const DWFString& zObjectID,
        ...
        // destructor
        _DWFTK_API virtual ~DWFEMapUpdateLayerGroupCommand() throw();
...
#endif // _DWFEMAPTK_UPDATELAYERGROUP_H
// End of file.
