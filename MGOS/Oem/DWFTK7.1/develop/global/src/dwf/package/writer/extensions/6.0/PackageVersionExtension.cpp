...
_DWFTK_API
void
DWFPackageVersion60Extension::prewriteManifest( DWFPackageWriter&          /*rPackageWriter*/, 
...
_DWFTK_API
void
DWFPackageVersion60Extension::postwriteManifest( DWFPackageWriter&         /*rPackageWriter*/,
                                                       DWFPackageFileDescriptor& /*rPackageDescriptor*/,
                                                       DWFXMLSerializer&         /*rXMLSerializer*/,
                                                       const DWFString&          /*rPackagePassword*/ )
throw( DWFException )
...
_DWFTK_API
void
DWFPackageVersion60Extension::postwriteSections( DWFPackageWriter&         /*rPackageWriter*/, 
                                                       DWFPackageFileDescriptor& /*rPackageDescriptor*/,
                                                       DWFXMLSerializer&         /*rXMLSerializer*/,
                                                       const DWFString&          /*rPackagePassword*/ )
throw( DWFException )
