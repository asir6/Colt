...
#ifndef _FS_GET_PLOT_H
#define _FS_GET_PLOT_H

class MgHttpGetPlot : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpGetPlot(MgHttpRequest *hRequest);
...
private:
    STRING  m_dwfVersion;
    STRING  m_eplotVersion;
    Ptr<MgMap> m_map;
    Ptr<MgLayout> m_layout;
    Ptr<MgPlotSpecification> m_plotSpec;
};

#endif  // _FS_GET_PLOT_H
