...
_DWFTK_API
void
DWFPackageVersionTypeInfoExtension::prewriteManifest( DWFPackageWriter&          /*rPackageWriter*/, 
...
throw( DWFException )
{
    ...
    {
        _DWFCORE_THROW( DWFInvalidTypeException, L"A document type must be specified" );
    }
...
_DWFTK_API
void
DWFPackageVersionTypeInfoExtension::postwriteManifest( DWFPackageWriter&         /*rPackageWriter*/,
                                                       DWFPackageFileDescriptor& /*rPackageDescriptor*/,
                                                       DWFXMLSerializer&         /*rXMLSerializer*/,
                                                       const DWFString&          /*rPackagePassword*/ )
throw( DWFException )
...
_DWFTK_API
void
DWFPackageVersionTypeInfoExtension::postwriteSections( DWFPackageWriter&         /*rPackageWriter*/, 
                                                       DWFPackageFileDescriptor& /*rPackageDescriptor*/,
                                                       DWFXMLSerializer&         /*rXMLSerializer*/,
                                                       const DWFString&          /*rPackagePassword*/ )
throw( DWFException )
