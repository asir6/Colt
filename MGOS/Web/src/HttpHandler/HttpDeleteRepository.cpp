...
#include "HttpDeleteRepository.h"

HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpDeleteRepository)
...
/// nothing
/// </returns>
MgHttpDeleteRepository::MgHttpDeleteRepository(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpDeleteRepository::Execute(MgHttpResponse& hResponse)
{
    ...
    // Run API command
    mgprService->DeleteRepository(&mgrIdentifier);

    MG_HTTP_HANDLER_CATCH_AND_THROW_EX(L"MgHttpDeleteRepository.Execute")
}
