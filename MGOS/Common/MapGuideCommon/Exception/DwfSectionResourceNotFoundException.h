...
#ifndef MG_DWF_SECTION_RESOURCE_NOT_FOUND_EXCEPTION_H_
#define MG_DWF_SECTION_RESOURCE_NOT_FOUND_EXCEPTION_H_
...
///
class MG_MAPGUIDE_API MgDwfSectionResourceNotFoundException : public MgApplicationException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = MapGuide_Exception_MgDwfSectionResourceNotFoundException;
};
