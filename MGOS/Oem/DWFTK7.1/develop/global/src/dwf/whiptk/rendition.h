...
public:
     ...
     */
    #define WHIP_ATTRIBUTE_MACRO(class_name, class_lower) \
        WT_##class_name const & class_lower()    const { return m_##class_lower; }
        WHIP_ATTRIBUTE_LIST
    #undef WHIP_ATTRIBUTE_MACRO
    //@}
     ...
     */
    #define WHIP_ATTRIBUTE_MACRO(class_name, class_lower) \
        WT_##class_name & class_lower() { m_changed_flags |= class_name##_Bit; return m_##class_lower; }
        WHIP_ATTRIBUTE_LIST
    #undef WHIP_ATTRIBUTE_MACRO
    //@}
     ...
     */
    WT_Result sync(WT_File & file, WT_Integer32 required = 0)
    {
