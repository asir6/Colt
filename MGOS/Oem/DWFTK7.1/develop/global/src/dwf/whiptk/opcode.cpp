    ...
    case Extended_ASCII:
        {
            ...
            case 'M':
                ...
                if (!strcmp((char const *)m_token,"(Macro"))
                {   
            ...
            case 'T':
                ...
                if (!strcmp((char const *)m_token,"(TextHAlign"))
                {
                ...
                if (!strcmp((char const *)m_token,"(TextVAlign"))
                {
                ...
                if (!strcmp((char const *)m_token,"(TextBackground"))
                {
