...
#include "dwf/expat/winconfig.h"
#elif defined(EXPAT_CONFIG_MACOSX)
#include "dwf/expat/macconfig.h"
#else
#ifdef HAVE_EXPAT_CONFIG_H
#include <expat_config.h>
#endif
#endif /* ndef EXPAT_COMPILED_FROM_DSP */
...
#include "dwf/expat/internal.h"
#include "dwf/expat/xmltok.h"
#include "dwf/expat/xmlrole.h"
...
errorProcessor(XML_Parser parser,
               ...
               const char **_unused3)
{
    (void)_unused1; (void)_unused2; (void)_unused3;
  return errorCode;
}
