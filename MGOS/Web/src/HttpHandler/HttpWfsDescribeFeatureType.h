...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpWfsDescribeFeatureType(MgHttpRequest *hRequest);
...
private:
    ...
    void GenerateTypeNameException(MgHttpResult* pResult, CREFSTRING sTypeNames);
};

#endif  // _FS_WFS_DESCRIBE_FEATURE_TYPE_H
