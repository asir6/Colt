...
#ifndef MG_INVALID_PRINT_LAYOUT_FONT_SIZE_UNITS_EXCEPTION_H_
#define MG_INVALID_PRINT_LAYOUT_FONT_SIZE_UNITS_EXCEPTION_H_
...
///
class MG_MAPGUIDE_API MgInvalidPrintLayoutFontSizeUnitsException : public MgApplicationException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = MapGuide_Exception_MgInvalidPrintLayoutFontSizeUnitsException;
};
