...
#ifndef MGSITESERVICEHANDLER_H
#define MGSITESERVICEHANDLER_H
...
class MG_SERVER_SITE_API MgSiteServiceHandler : public IMgServiceHandler
{
public:
    ///////////////////////////////////////////////////////////////////////////
    /// Constructor/Destructor
    MgSiteServiceHandler(MgStreamData* data, const MgOperationPacket& packet);
    virtual ~MgSiteServiceHandler( void );
