...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpGetResourceData)
...
/// nothing
/// </returns>
MgHttpGetResourceData::MgHttpGetResourceData(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpGetResourceData::Execute(MgHttpResponse& hResponse)
{
    ...
    MG_HTTP_HANDLER_CATCH_AND_THROW_EX(L"MgHttpGetResourceData.Execute")
}
