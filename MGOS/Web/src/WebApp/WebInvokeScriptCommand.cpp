...
// Constructor
//
MgWebInvokeScriptCommand::MgWebInvokeScriptCommand()
{
    m_action = MgWebActions::InvokeScript;
}
...
//
INT32 MgWebInvokeScriptCommand::GetClassId()
{
    return m_cls_id;
}
...
// Dispose this object
//
void MgWebInvokeScriptCommand::Dispose()
{
    delete this;
}
