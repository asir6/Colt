...
DWFEMapTransactionSectionDescriptorReader::DWFEMapTransactionSectionDescriptorReader(
...
DWFEMapTransactionSectionDescriptorReader::~DWFEMapTransactionSectionDescriptorReader(void)
throw()
{
}
