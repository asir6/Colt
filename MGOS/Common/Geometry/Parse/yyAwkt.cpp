...
#define gis_awkt_yyclearin (pParse->gis_awkt_yychar=(-1))
...
#line 42 "src\\geometry\\Parse\\yyAwkt.y"
#if 0
{
...
#endif
#endif
#define gis_awkt_yystacksize GIS_AWKT_YYSTACKSIZE
#line 163 "src\\geometry\\Parse\\yyAwkt.y"
///////////////////////////////////////////////////////////////////////
...
INT32 gis_awkt_yyparse(MgParseAwkt* pParse)
{
    register int gis_awkt_yym, gis_awkt_yyn, gis_awkt_yystate;
#if GIS_AWKT_YYDEBUG
    register char *gis_awkt_yys;
...
#endif
        if (pParse->gis_awkt_yyssp >= pParse->gis_awkt_yyss + gis_awkt_yystacksize - 1)
        {
...
break;
case 44:
#line 137 "src\\geometry\\Parse\\yyAwkt.y"
{Node_Trace(L"PointCollection[1]\n");}
break;
case 45:
#line 138 "src\\geometry\\Parse\\yyAwkt.y"
{Node_Trace(L"PointCollection[n]\n");}
break;
case 46:
#line 140 "src\\geometry\\Parse\\yyAwkt.y"
{Node_Trace(L"LineStringCollection[1]\n");}
break;
case 47:
#line 141 "src\\geometry\\Parse\\yyAwkt.y"
{pParse->SetBreak();}
break;
case 48:
#line 141 "src\\geometry\\Parse\\yyAwkt.y"
...
break;
case 49:
#line 143 "src\\geometry\\Parse\\yyAwkt.y"
{Node_Trace(L"PolygonCollection[1]\n");}
break;
case 50:
#line 144 "src\\geometry\\Parse\\yyAwkt.y"
...
break;
case 52:
#line 146 "src\\geometry\\Parse\\yyAwkt.y"
{Node_Trace(L"AwktCollection[1]\n");}
break;
case 53:
#line 147 "src\\geometry\\Parse\\yyAwkt.y"
{Node_Trace(L"AwktCollection[n]\n");}
break;
case 54:
#line 150 "src\\geometry\\Parse\\yyAwkt.y"
{pParse->SetSegmentType(GisToken_CIRCULARARCSEGMENT);}
break;
case 56:
#line 151 "src\\geometry\\Parse\\yyAwkt.y"
{pParse->SetSegmentType(GisToken_LINESTRINGSEGMENT);}
break;
case 58:
#line 153 "src\\geometry\\Parse\\yyAwkt.y"
{Node_Trace(L"CurveSegmentCollection[1]\n");}
break;
case 59:
#line 154 "src\\geometry\\Parse\\yyAwkt.y"
{Node_Trace(L"CurveSegmentCollection[n]\n");}
break;
case 60:
#line 156 "src\\geometry\\Parse\\yyAwkt.y"
{Node_Trace(L"CurveStringCollection[1]\n");}
break;
case 61:
#line 157 "src\\geometry\\Parse\\yyAwkt.y"
{pParse->SetBreak();}
break;
case 62:
#line 157 "src\\geometry\\Parse\\yyAwkt.y"
...
break;
case 63:
#line 159 "src\\geometry\\Parse\\yyAwkt.y"
{Node_Trace(L"CurvePolygonCollection[1]\n");}
break;
case 64:
#line 160 "src\\geometry\\Parse\\yyAwkt.y"
{pParse->SetOuterBreak();}
break;
case 65:
#line 160 "src\\geometry\\Parse\\yyAwkt.y"
