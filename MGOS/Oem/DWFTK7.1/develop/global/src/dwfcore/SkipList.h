...
class DWFSkipList : public DWFCoreMemory
{
...
public:
        ...
        , _nCount( 0 )
    {
        ...
        if (_pHeader == NULL)
        {
            _DWFCORE_THROW( DWFMemoryException, L"Failed to allocate header node" );
        }
    }
...
public:
    ...
    ///\since       1.0.1
    ///
    class Iterator : public DWFCoreMemory
    ...
    public:
            ...
            throw( DWFException )
        {
            ...
            {
                _DWFCORE_THROW( DWFIllegalStateException, L"Cannot get key from iterator" );
            }
        }
            ...
            throw( DWFException )
        {
            ...
            {
                _DWFCORE_THROW( DWFIllegalStateException, L"Cannot get value from iterator" );
            }
        }
...
public:
        ...
        throw( DWFException )
    {
        if (iPos >= _nCount)
        {
            _DWFCORE_THROW( DWFOverflowException, L"Index exceeds list size" );
        }
        ...
        throw( DWFException )
    {
        ...
        else
        {
            ...
            {
                _DWFCORE_THROW( DWFMemoryException, L"Failed to allocate node" );
            }
...
class DWFSortedList : public DWFCoreMemory
{
...
public:
    ...
    ///\throw   None
    ///
    virtual bool exists( const T& rT )
        throw()
    {    
...
class DWFCharKeyHashList    : public DWFCoreMemory
{
...
public:
    ...
    ///
    virtual T* find( const char*& rKey )
        throw()
    {
...
class DWFWCharKeyHashList   : public DWFCoreMemory
{
...
public:
    ...
    ///\copydoc DWFSkipList::find()
    ///
    virtual T* find( const wchar_t*& rKey )
        throw()
    {
        return _oList.find( _tHash(rKey) );
    }
...
class DWFChainedSkipList    : public DWFCoreMemory
{
...
public:
    ...
    ///\throw   None
    ///
    virtual size_t size( const PK& rPKey )
        throw()
    {
    ...
    ///\throw   None
    ///
    virtual V* find( const PK& rPKey, const SK& rSKey )
        throw()
    {
        DWFSkipList<SK, V, SE, SL, SZ>** ppChain = _oChains.find( rPKey );
        ...
        throw( DWFException )
    {
        ...
        else
        {
            ...
            if (pNewChain == NULL)
            {
                _DWFCORE_THROW( DWFMemoryException, L"Failed to allocate chain" );
            }
