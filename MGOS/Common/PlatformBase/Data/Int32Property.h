...
#ifndef INT32_PROPERTY_H
#define INT32_PROPERTY_H

/// \defgroup MgInt32Property MgInt32Property
...
///
class MG_PLATFORMBASE_API MgInt32Property : public MgNullableProperty
{
    MG_DECL_DYNCREATE();
    DECLARE_CLASSNAME(MgInt32Property)
...
CLASS_ID:
    static const INT32 m_cls_id = PlatformBase_Property_Int32Property;
};
/// \}
