...
IMPLEMENT_EXCEPTION_DEFAULTS(MgDbXmlException, MgThirdPartyException)

///////////////////////////////////////////////////////////////////////////////
/// \brief
/// Construct a MgDbXmlException object.
///
MgDbXmlException::MgDbXmlException(CREFSTRING methodName,
...
/// Destruct the object.
///
MgDbXmlException::~MgDbXmlException() throw()
{
}
