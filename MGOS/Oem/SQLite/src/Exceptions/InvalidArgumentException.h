...
#ifndef _INVALID_ARGUMENT_EXCEPTION_H
#define _INVALID_ARGUMENT_EXCEPTION_H
...
EXTERNAL_API:
    ...
    //////////////////////////////////////////////////////////////////
    ///<summary>
    /// Construct a InvalidArgumentException object
    ...
    ///</summary>
    ///
    InvalidArgumentException(CREFSTRING methodName, UINT32 lineNumber, CREFSTRING fileName, CREFSTRING message) throw();

    //////////////////////////////////////////////////////////////////
    ///<summary>
    /// Destructor for a InvalidArgumentException object
    ///</summary>
    ///
...
#endif //_INVALID_ARGUMENT_EXCEPTION_H
