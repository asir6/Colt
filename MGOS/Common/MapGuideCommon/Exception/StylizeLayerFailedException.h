...
#ifndef MG_STYLIZE_LAYER_FAILED_EXCEPTION_H_
#define MG_STYLIZE_LAYER_FAILED_EXCEPTION_H_

///////////////////////////////////////////////////////////////////////////////
/// \brief
/// Thrown when a stylize layer fails.
///
class MG_MAPGUIDE_API MgStylizeLayerFailedException : public MgApplicationException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = MapGuide_Exception_MgStylizeLayerFailedException;
};
