...
//
//  <summary>
//  Constructs a MgTileServiceHandler object with the given parameters.
//  </summary>
//
//  <param name = "data">
...
//  data stream.
//  </param>
MgTileServiceHandler::MgTileServiceHandler(MgStreamData* data,
...
///////////////////////////////////////////////////////////////////////////
//  <summary>
//  The destructor for the MgTileServiceHandler object.
//  </summary>
MgTileServiceHandler::~MgTileServiceHandler( void )
{
}
...
IMgServiceHandler::MgProcessStatus MgTileServiceHandler::ProcessOperation()
{
    ...
    handler.reset(MgTileOperationFactory::GetOperation(
    ...
    MG_CATCH(L"MgTileServiceHandler.ProcessOperation")
