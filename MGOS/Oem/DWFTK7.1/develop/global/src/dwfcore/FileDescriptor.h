...
public:
        ...
        throw( DWFException )
    {
        ...
        _DWFCORE_THROW( DWFNotImplementedException, L"Read operation not implemented for this descriptor" );
    }
        ...
        throw( DWFException )
    {
        ...
        _DWFCORE_THROW( DWFNotImplementedException, L"Seek operation not implemented for this descriptor" );
    }
        ...
        throw( DWFException )
    {
        ...
        _DWFCORE_THROW( DWFNotImplementedException, L"Write operation not implemented for this descriptor" );
    }
    ...
    virtual void flush()
    {
        _DWFCORE_THROW( DWFNotImplementedException, L"Flush operation not implemented for this descriptor" );
    }
