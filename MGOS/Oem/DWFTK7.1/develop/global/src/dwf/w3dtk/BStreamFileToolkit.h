...
*/
class BBINFILETK_API BControlledMemoryObject {
    public:
...
*/
class BBINFILETK_API Internal_Data_Accumulator {
    private:
...
class BBINFILETK_API Internal_Translator {
...
class BBINFILETK_API Internal_Key_Record {
    private:
...
*/
class BBINFILETK_API BStreamFileToolkit : public BControlledMemoryObject {
    ...
    protected:
        ...
        Internal_Key_Record             m_visited_segments;     /*!< All segments seen so far. (prevents multiple transmission of includes) */
    ...
    public:
        ...
        */
        ...
        int         GetFlags (void) const       { return GetWriteFlags(); }     /*!< Returns the writing flags set on the toolkit.  Obselete.  Use GetWriteFlags */
        void        SetFlags (int flags) alter  { SetWriteFlags(flags); }       /*!< Sets the toolkit writing flags. Obselete.  Use SetWriteFlags */
    ...
    protected:
        ...
        void        remember_segment (ID_Key key) alter;
        bool        find_segment (ID_Key key) const;
