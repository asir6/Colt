...
#ifndef _FS_KML_GET_FEATURES_H
#define _FS_KML_GET_FEATURES_H

class MgHttpKmlGetFeatures : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpKmlGetFeatures(MgHttpRequest *hRequest);
