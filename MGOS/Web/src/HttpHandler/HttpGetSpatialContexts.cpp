...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpGetSpatialContexts)
...
/// nothing
/// </returns>
MgHttpGetSpatialContexts::MgHttpGetSpatialContexts(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpGetSpatialContexts::Execute(MgHttpResponse& hResponse)
{
