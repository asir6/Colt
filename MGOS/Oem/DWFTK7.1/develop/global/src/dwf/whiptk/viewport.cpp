...
WT_Viewport::WT_Viewport(
    ...
    , m_incarnation(file.next_incarnation())
{
    m_contour_set = new WT_Contour_Set(boundary, WD_True);
    if (!m_contour_set)
        throw WT_Result::Out_Of_Memory_Error;
}
...
///////////////////////////////////////////////////////////////////////////
// Copy constructor
WT_Viewport::WT_Viewport(WT_Viewport const & vport)
    : WT_Attribute()
    , m_stage(Eating_Initial_Whitespace)
...
///////////////////////////////////////////////////////////////////////////
void WT_Viewport::set(WT_Viewport const & viewport, WT_Boolean )
{
    m_name = viewport.m_name;
    ...
    if(viewport.m_contour_set) {
        m_contour_set = new WT_Contour_Set(*viewport.m_contour_set);
        if (!m_contour_set)
            throw WT_Result::Out_Of_Memory_Error;
    }
    else 
