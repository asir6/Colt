...
#ifndef _FS_GET_MAP_LEGEND_IMAGE_H
#define _FS_GET_MAP_LEGEND_IMAGE_H

class MgHttpGetMapLegendImage : public MgHttpRequestResponseHandler
{
...
public:
    ...
    /// nothing
    /// </returns>
    MgHttpGetMapLegendImage(MgHttpRequest *hRequest);
...
#endif  // _FS_GET_MAP_LEGEND_IMAGE_H
