...
HTTP_IMPLEMENT_CREATE_OBJECT(MgHttpDescribeDrawing)
...
/// nothing
/// </returns>
MgHttpDescribeDrawing::MgHttpDescribeDrawing(MgHttpRequest *hRequest)
{
...
/// </returns>
void MgHttpDescribeDrawing::Execute(MgHttpResponse& hResponse)
{
