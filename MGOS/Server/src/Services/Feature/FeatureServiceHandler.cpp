...
//
//  <summary>
//  Constructs a MgFeatureServiceHandler object with the given parameters.
//  </summary>
//
//  <param name = "data">
...
//  data stream.
//  </param>
MgFeatureServiceHandler::MgFeatureServiceHandler(MgStreamData* data,
...
///////////////////////////////////////////////////////////////////////////
//  <summary>
//  The destructor for the MgFeatureServiceHandler object.
//  </summary>
MgFeatureServiceHandler::~MgFeatureServiceHandler( void )
{
}
...
IMgServiceHandler::MgProcessStatus MgFeatureServiceHandler::ProcessOperation()
{
    ...
    handler.reset(MgFeatureOperationFactory::GetOperation(
    ...
    MG_CATCH(L"MgFeatureServiceHandler.ProcessOperation")
