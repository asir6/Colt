...
#ifndef MG_HTTP_SET_RESOURCE_H
#define MG_HTTP_SET_RESOURCE_H

class MgHttpSetResource : public MgHttpRequestResponseHandler
{
...
public:
    ...
    MgHttpSetResource(MgHttpRequest* hRequest);
