...
///////////////////////////////////////////////////////////////////////////
void WT_Point_Set::transform(WT_Transform const & transform)
{
    if (!m_transformed)
    {
...
///////////////////////////////////////////////////////////////////////////
#if DESIRED_CODE(WHIP_OUTPUT)
void WT_Point_Set::relativize(WT_File & file)
{
    if (!m_relativized)
    {
        WT_Logical_Point *    source = m_points;
...
#else
void WT_Point_Set::relativize(WT_File &)
{}
#endif  // DESIRED_CODE()

///////////////////////////////////////////////////////////////////////////
void WT_Point_Set::de_relativize(WT_File & file)
{
    if (m_relativized)
    {
        WT_Logical_Point *    source = m_points;
...
WT_Boolean WT_Point_Set::first_point_fits_in_16_bits() const
{
#if DESIRED_CODE(WHIP_OUTPUT)
...
// itself, since the "relativization" timing depends on the higher level routines.
//  (WT_File gets changed)
WT_Boolean WT_Point_Set::remaining_points_fit_in_16_bits() const
{
#if DESIRED_CODE(WHIP_OUTPUT)
...
///////////////////////////////////////////////////////////////////////////
WT_Boolean WT_Point_Set::operator== (WT_Point_Set const & set) const
{
