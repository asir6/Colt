...
MgUserInfo::MgUserInfo() : m_passwordEncrypted(false)
{
}
...
MgUserInfo::MgUserInfo(const MgUserInfo& userInfo)
{
    *this = userInfo;
}
...
MgUserInfo& MgUserInfo::operator=(const MgUserInfo& userInfo)
{
    if (this != &userInfo)
    {
        m_passwordEncrypted = userInfo.m_passwordEncrypted;
...
void MgUserInfo::SetPassword(CREFSTRING password, bool passwordEncrypted)
{
